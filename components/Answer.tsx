  ...
  return (
    <div className="max-w-[800px] space-y-4 py-16 px-8 sm:px-24 sm:pt-16 pb-32">
      ...
      <div className="border-b border-zinc-800 pb-4">
        <div className="text-md text-blue-500">Odpowiedź</div>
      ...
      {done && (
        <>
          <div className="border-b border-zinc-800 pb-4">
            <div className="text-md text-blue-500">Korzystałem z takich źródeł</div>
          ...
          >
            <IconReload size={18} />
            <div className="ml-2">Zadaj AI nowe pytanie</div>
          </button>
        </>
      )}
    </div>
